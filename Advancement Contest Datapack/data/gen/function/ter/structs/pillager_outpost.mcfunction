...
data merge storage gen {l:{type:"structure",id:"pillager_outpost"}}
...
scoreboard players operation has_p_outpost gen = in_range gen
execute unless score in_range gen matches 1.. run return fail

data modify storage map:main dec append value {x:0,z:0,char:"p"}
