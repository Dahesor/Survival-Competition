...
tellraw @a [{text:"[gen:locator] 在 (",color:"dark_gray"},{score:{name:"x",objective:"gen"}}, ", ",{score:{name:"z",objective:"gen"}},")","发现目标，距离",{score:{name:"distance",objective:"gen"}},{text:"",color:"gray",extra:[" (",{score:{name:"time",objective:"gen"}},"ms)"]}]
