...
execute if score $fortress gen matches 9.. run scoreboard players set phase gen 302
...
data modify storage map:main single_dec set value {x:0,z:0,char:"f"}
...
scoreboard players add has_fortress gen 1
