...
execute if entity @a[tag=dsc.__mapping_request] run function map:page/dialog
execute if score $map_frame calc.DSC matches ..0 if entity @a[tag=dsc.mapping] run function map:page/dialog