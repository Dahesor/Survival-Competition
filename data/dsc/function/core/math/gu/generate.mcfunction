...
execute unless score @s gu.uuid.0 matches -2147483648.. run function dsc:core/math/gu/zzz/store_uuid
...
function dsc:core/math/gu/zzz/get_hexes with storage gu:temp
function dsc:core/math/gu/zzz/concat_uuid with storage gu:temp